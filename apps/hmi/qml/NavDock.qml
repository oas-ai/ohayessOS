        ...
        Repeater {
            ...
            delegate: Button {
                ...
                background: Rectangle {
                    radius: 19
                    color: dock.selected === entry.index ? Theme.selection : entry.hovered ? Qt.rgba(Theme.muted.r, Theme.muted.g, Theme.muted.b, 0.12) : "transparent"
                    border.color: entry.activeFocus ? Theme.cyan : dock.selected === entry.index ? Theme.selectionBorder : "transparent"
