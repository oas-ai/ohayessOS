...
// 03 Media, expanded stage. The mini player is suppressed here to avoid two
// copies of the same transport on one screen.
Item {
    id: screen
    ...
    RowLayout {
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    Icon {
                        ...
                        name: "media"
                        size: Tokens.iconXl
                        tone: screen.allowed ? Tokens.accent : Tokens.textTertiary
                    }
                }
        ...
        Panel {
            visible: Tokens.showSideColumns && screen.media.connected
                ...
                Repeater {
                    ...
                    delegate: Item {
                        ...
                        Rectangle {
                            ...
                            radius: Tokens.rMd
                            color: index === 0 ? Tokens.accentWash : "transparent"
                        }
                        ...
                        Column {
                            ...
                            Text {
                                ...
                                width: parent.width
                                elide: Text.ElideRight
                                color: index === 0 ? Tokens.textPrimary : Tokens.textSecondary
                                font.pixelSize: Tokens.bodyMd
                                font.weight: index === 0 ? Tokens.weightMedium : Tokens.weightRegular
                            }
